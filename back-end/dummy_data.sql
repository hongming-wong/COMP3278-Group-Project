...
CREATE TABLE Record(
	recordID VARCHAR(10) NOT NULL, date_year VARCHAR(10) NOT NULL,
...
INSERT INTO Customer (customerID, login_date, login_time, name) VALUES ('1', '2021-09-01', '20-45', 'Joe');
INSERT INTO Customer (customerID, login_date, login_time, name) VALUES ('2', '2021-09-03', '15-45', 'Mary');
INSERT INTO Customer (customerID, login_date, login_time, name) VALUES ('3', '2021-09-05', '20-40', 'John');
INSERT INTO Customer (customerID, login_date, login_time, name) VALUES ('4', '2021-09-07', '20-41', 'Cindy');
INSERT INTO Customer (customerID, login_date, login_time, name) VALUES ('5', '2021-09-08', '20-44', 'Leon');
INSERT INTO Customer (customerID, login_date, login_time, name) VALUES ('6', '2021-09-10', '20-42', 'Janice');

INSERT INTO Account (account_number, currency, balance, customerID) VALUES ('1', 'HKD', 500, '1');
INSERT INTO Account (account_number, currency, balance, customerID) VALUES ('2', 'HKD', 500, '1');
INSERT INTO Account (account_number, currency, balance, customerID) VALUES ('3', 'USD', 500, '2');
INSERT INTO Account (account_number, currency, balance, customerID) VALUES ('4', 'USD', 500, '3');
INSERT INTO Account (account_number, currency, balance, customerID) VALUES ('5', 'HKD', 500, '5');
...
INSERT INTO SavingAccount (account_number) VALUES ('4');
...
INSERT INTO Record (recordID, date_year, date_month, date_day, date_time, amount, account_number) VALUES ('3', '2021', '10', '26', '10-02', 10, '1');
INSERT INTO Record (recordID, date_year, date_month, date_day, date_time, amount, account_number) VALUES ('4', '2021', '10', '26', '10-03', 100, '3');
INSERT INTO Record (recordID, date_year, date_month, date_day, date_time, amount, account_number) VALUES ('5', '2021', '10', '26', '10-04', 30, '2');
INSERT INTO Record (recordID, date_year, date_month, date_day, date_time, amount, account_number) VALUES ('6', '2021', '10', '26', '10-05', 60, '4');

INSERT INTO Transaction (transactionID, date_year, date_month, date_day, date_time, amount, message, CurrentAccount_number, SavingAccount_number) VALUES ('1', '2021', '10', '26', '11-00', 50, 'Hello', '5', '2');
INSERT INTO Transaction (transactionID, date_year, date_month, date_day, date_time, amount, message, CurrentAccount_number, SavingAccount_number) VALUES ('2', '2021', '10', '26', '11-02', 10, 'Hi', '5', '1');

INSERT INTO Transaction (transactionID, date_year, date_month, date_day, date_time, amount, message, CurrentAccount_number, SavingAccount_number) VALUES ('3', '2021', '10', '26', '11-04', 20, 'Hellooo', '6', '3');
INSERT INTO Transaction (transactionID, date_year, date_month, date_day, date_time, amount, message, CurrentAccount_number, SavingAccount_number) VALUES ('4', '2021', '10', '26', '11-05', 50, 'HelloHI', '7', '4');
INSERT INTO Transaction (transactionID, date_year, date_month, date_day, date_time, amount, message, CurrentAccount_number, SavingAccount_number) VALUES ('5', '2021', '10', '26', '11-07', 100, 'Hellohiihi', '7', '4');
